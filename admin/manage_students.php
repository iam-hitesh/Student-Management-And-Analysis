...
<?php
	...
	if(isset($_POST['add_marks'])){
        ...
        $students_sql = "SELECT regno,fname,lname,branch,session,batch FROM students_list where branch='$branch' and session='$session' or fname='$fname' or regno='$regno'";
        ...
        $num_rows = mysqli_num_rows($students_query);
            ...
            while($row = mysqli_fetch_array($students_query)){
                        ...
                        $lname = $row['lname'];
                        echo "<tr>";
                        echo "<td><a target=\"blank\" href=\"student_profile.php?view=".$reg ."\">".$reg ."</a></td>";
