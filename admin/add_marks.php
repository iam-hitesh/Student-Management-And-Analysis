   ...
   if(isset($_POST['add_marks'])){
        ...
        $num_rows = mysqli_num_rows($marks_query);
            ...
            while($row = mysqli_fetch_array($marks_query)){
                        ...
                        $fname = $row['fname'];
                        $lname = $row['lname'];
                        echo "<form action=\"action/submit_marks.php?r=".$num_rows."&&reg=".$reg."\" method=\"POST\">";
                        echo "<tr>";
                        echo "<td>" .$reg . "</td>";
                        ...
                        echo "<td><input type=\"text\" name=\"max_marks[]\"></td>";
                        ...
                        echo "</table>";
                        echo "<input type=\"submit\" name=\"submit_marks\" class=\"btn btn-primary\" required=\"true\" >";
                        echo "</form>";
